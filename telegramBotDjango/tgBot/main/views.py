...
def index(request):
    ...
    object = ChatIds.objects.filter(caffeName = name)
    adress.setChatId(get_value_from_model_using_sql())
    print(str(object))
    return render(request, 'main.html')



def get_value_from_model_using_sql():
    sql_query = "SELECT chatId FROM main_ChatIds WHERE caffeName = 'secondCaffe'"
